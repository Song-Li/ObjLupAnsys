...
def parse_args():
    ...
    parser.add_argument('--max-rep', type=int, default=4, help="If set, it will limit of the max time of calls of each function in the call stack to max-rep")
    parser.add_argument('--run-all-files', action='store_true', default=False, help="If set, it will run all files of a package")
    parser.add_argument('--no-prioritized-funcs', action='store_true', default=False, help="If set, it will not try to run prioritized functions before everything")
    parser.add_argument('--entrance-func', type=str, help="If set, it will start from a specified function")
    ...
    parser.add_argument('--no-exports', action='store_true', default=False, help="if set, it will never run exported functions")
    parser.add_argument('--max-file-stack', type=int, help="If set, it will limit the max size of file stack to max-file-stack")
    parser.add_argument('--skip-func', type=str, help="If set, it will skip a list of functions, separated by ,")
