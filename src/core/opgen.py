...
class OPGen:
    ...
    def _test_graph(self, G: Graph, vul_type='proto_pollution'):
        """
    ...
    def test_module(self, module_path, vul_type='proto_pollution', G=None, 
    ...
    def run(self):
        ...
        if options.parallel is not None:
            ...
            for i in range(num_thread):
                ...
                os.system(f"screen -S runscreen_{i} -dm python3 {cur_cmd}")
            return 
